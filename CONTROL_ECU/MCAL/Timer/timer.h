...
typedef enum{
	...
	TIMER0_EXTERNAL_CLK_RISING, TIMER0_EXTERNAL_CLK_FALLING
}TIMER0_Prescaler;
...
typedef enum{
	...
	TIMER1_EXTERNAL_CLK_RISING, TIMER1_EXTERNAL_CLK_FALLING
}TIMER1_Prescaler;
...
typedef struct{
	TIMER_ModeData mode_data;
	TIMER_ID timer_id;
	TIMER_Mode mode;
	TIMER_GeneralPrescaler prescaler;
	TIMER_CompareOutput ocx_pin_behavior;
